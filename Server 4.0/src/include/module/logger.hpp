//
// Created by firewolf304 on 19.03.24.
//

#ifndef SERVER4_0_LOGGER_HPP
#define SERVER4_0_LOGGER_HPP
#include "../include.hpp"
...
namespace firewolf::logger::glog {
    void awdawd() {
        //LOG(INFO) << "123";
    }
}

namespace firewolf::logger::self {
    class log_streamer {
    public:
        /*======config======*/
        struct d {
